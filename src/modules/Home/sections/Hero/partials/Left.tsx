  ...
  return (
    <div  className='relative col-span-2 z-10 md:text-center lg:text-left !mt-[-20px] ' >
        ...
        <div className='relative' >
            <AnimatedTextWord 
               text="Hi, my name is"
               className='text-lg justify-center lg:justify-start text-white'
            />
            ...
            <div className='my-5 md:my-8 leading-7 text-slate-400 md:text-lg max-w-3xl' >
               <AnimatedTextWord 
                  text="Highly motivated and very passionate Backend Developer with 8 years of experience in Django and Laravel"
